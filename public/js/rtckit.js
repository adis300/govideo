/* this is adapted from SimpleWebRTC library
*
* https://simplewebrtc.com
* With socketIO layer removed and uses websocket directly.
* The server end and this library has been re-written.
* - Adis
*/
    ...
    if (self.config.connection === null) {
        ...
        self.connection.emit = function(event, payload){
            if(self.connection){
                ...
                }else alert('Not connected to GoVideo server, should reconnect here');
            }else alert('Not connected to GoVideo server, should reconnect here');
        };
